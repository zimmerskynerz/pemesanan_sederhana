            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="tambahPenggunaTitle">Tambah User Pengguna!</h5>
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            <form method="POST" action="../include/query_sql.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="jabatan">Pilih Jabatan Pengguna Toko</label>
        ...
        <script type="text/javascript">
            $(document).on("click", "#user_detail", function() {
                ...
                $(".modal-body#d_user #tgl_lahir").val(Tgl_lahir);
        ...
        <div class="modal fade" id="tambahMember" tabindex="-1" role="dialog" aria-labelledby="tambahMemberTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="tambahMemberTitle">Tambah Member Toko!</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            <form method="POST" action="../include/query_sql.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="luas" name="luas" placeholder="Luas Barang">
                                    <small>Panjang X Lebar X Tinggi</small>
                                </div>
        ...
        <div class="modal fade" id="laporanNew" tabindex="-1" role="dialog" aria-labelledby="laporanNewLabel" aria-hidden="true">
            ...
            <!-- Modal -->
        <div class="modal fade" id="laporanCetak" tabindex="-1" role="dialog" aria-labelledby="laporanCetakLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="laporanCetakLabel">Cetak Laporan!</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="cetak.php" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" name="laporanCetak" id="laporanCetak" class="btn btn-success"><i class="fa fa-print"></i> Cetak Data</button>
                            </div>
                        </form>
                    </div>
                </div>
