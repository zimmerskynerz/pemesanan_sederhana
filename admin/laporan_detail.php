                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $bulan   = $_GET['bulan'];
                                        $tahun   = $_GET['tahun'];
                                        $sql_tampil = "SELECT *, date_format(A.tgl_transaksi, '%d %M %Y') as tgl_transaksi FROM `tbl_transaksi` as A INNER JOIN tbl_user WHERE A.status='TERKIRIM' AND month(A.tgl_transaksi)='$bulan' AND YEAR(A.tgl_transaksi)='$tahun' group by A.id_transaksi";
